...
#### 💙 Feature 01 : 단일 Chunk가 하나의 완결된 의미론적 구성을 지녀야 한다.
...
#### 💙 Feature 02 : 단일 Chunk는 밀집된 정보포화도를 가져야 한다.
...
<figure><img src="../.gitbook/assets/image (1).png" alt="" width="375"><figcaption><p>[Figure. 01] Lost in the Middle: How Language Models Use Long Contexts</p></figcaption></figure>
...
#### 💙 Feature 03 : 단일 Chunk는 정보계층도를 반영하여 구성될수록 완성도가 높다.
...
<figure><img src="../.gitbook/assets/image (2).png" alt=""><figcaption><p>[Figure. 02] Contextual Retrieval (출처 : <a href="https://www.anthropic.com/news/contextual-retrieval">https://www.anthropic.com/news/contextual-retrieval</a>)</p></figcaption></figure>
...
이처럼 chunking은 단순하게 corpus를 splitting하는 작업이 아닌 chunk의 구성까지 고려해야 하는 굉장히 까다로운 작업인 것이다. 또한 위의 내용을 바탕으로 필자가 생각하는 가장 베스트인 chunking 방식이 존재하는데 그것을 공유하는 것은 꽤나 나중의 일에 될 것 같다. 그럼에도 우리는 chunking 방식의 효과를 항상 증명해야 하기때문에 다음 포스팅에 이어서 chunking 잡으러 가보자 🐳
