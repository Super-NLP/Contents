...
<figure><img src="../.gitbook/assets/image.png" alt=""><figcaption><p><strong>Figure 01</strong> : RAG Metric List (<a href="https://github.com/Marker-Inc-Korea/AutoRAG?tab=readme-ov-file">https://github.com/Marker-Inc-Korea/AutoRAG?tab=readme-ov-file</a>)</p></figcaption></figure>
...
* **정보표현여부에 따른 분류** : Conversation에 포함된 정보의 표현방식에 기반하였는지에 따른 분류이다.
