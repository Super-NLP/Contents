...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>우리의 evaluation은 검색 정확도와 효율성을 토큰 단위로 세밀하게 분석하는 접근 방식을 취하여, chunking과 같은 구성 요소를 반영할 수 있습니다. AI 응용 프로그램에서는 관련 토큰이 존재하는지가, 그들의 상대적 순위보다 더 중요하게 작용합니다.</p></figcaption></figure>
